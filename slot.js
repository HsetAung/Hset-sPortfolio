$(document).ready(function () {
 ...
 $("#moneyUnit").text("Total:");
  ...
  function beforeClickCondition() {
    $(".box").css("background-image", 'url("guss.jpg")');
  }
  ...
  function shuffleBox(boxId, goNextBox) {
    ...
    function animate() {
      ...
      // Check if the screen width is less than or equal to 768px (adjust the value based on your needs)
      if ($(window).width() <= 768) {
        box_Id.animate({ width: "43px", height: "70px" });
      } else {
    ...
    setTimeout(function () {
      ...
      $("#spinBtn").css({
        ...
        "box-shadow": "none",
         ...
         // Check if the screen width is less than or equal to 768px (adjust the value based on your needs)
    if ($(window).width() <= 768) {
      $(".box").animate({ width: "43px", height: "60px" });
    } else {
